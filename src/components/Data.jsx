...
const Data = () => {
  return (
    <div className='home-data'>
        <h1 className='home-title'>Richman L Tembo
        <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
        ...
        <p className='home-description'>I'm a junior software developer based
          in Bulawayo, passionate and dedicated to my work.
        </p>
